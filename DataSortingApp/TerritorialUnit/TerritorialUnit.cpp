...
TerritorialUnit::TerritorialUnit(const std::wstring& name, TerritorialUnitType type, const std::shared_ptr<ITerritorialUnit>& parent, unsigned int preProductive, 
...
TerritorialUnitType TerritorialUnit::getType() const
{
	return m_type;
}
